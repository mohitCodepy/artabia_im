const { abi } = require('../../../artifacts/contracts/ERC721Marketplace/ERC721ListingMarketplace.sol/ERC721ListingMarketplace.json')

const estimateGasPriceAndTime = require('../../utils/estimateGasPriceAndTime')

class ERC721ListingMarketplace {
  ...
  async createListing(tokenAddress, tokenId) {
...
ERC721ListingMarketplace.isIntegrationClass = true

module.exports = ERC721ListingMarketplace
