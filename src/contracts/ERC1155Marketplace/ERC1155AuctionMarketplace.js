const { abi } = require('../../../artifacts/contracts/ERC1155Marketplace/ERC1155AuctionMarketplace.sol/ERC1155AuctionMarketplace.json')

const estimateGasPriceAndTime = require('../../utils/estimateGasPriceAndTime')

class ERC1155AuctionMarketplace {
  ...
  async createAuction(tokenAddress, tokenId, tokenQty, endsAt) {
...
ERC1155AuctionMarketplace.isIntegrationClass = true

module.exports = ERC1155AuctionMarketplace
