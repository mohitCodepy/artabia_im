const { abi } = require('../../../artifacts/contracts/ERC1155Marketplace/ERC1155OrderMarketplace.sol/ERC1155OrderMarketplace.json')

const estimateGasPriceAndTime = require('../../utils/estimateGasPriceAndTime')

class ERC1155OrderMarketplace {
  ...
  async createOrder(tokenAddress, tokenId, tokenQty, price) {
...
ERC1155OrderMarketplace.isIntegrationClass = true

module.exports = ERC1155OrderMarketplace
